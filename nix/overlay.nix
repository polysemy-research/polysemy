...
let
  ...
  in {
    # doctest = hs.unmarkBroken (hs.doJailbreak super.doctest_0_20_0);
    doctest = hs.dontCheck (hs.overrideSrc hold.doctest_0_20_0 { src = self.inputs.doctest; }); # doJailbreak hold.doctest_0_20_0;

    cabal-doctest = hs.doJailbreak super.cabal-doctest;
      # if is92
